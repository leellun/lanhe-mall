/*
 ...
 Source Schema         : lanhe_ums

 Target Server Type    : MySQL
 Target Server Version : 80031
 File Encoding         : 65001

 Date: 12/02/2023 14:55:55
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_admin_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 196 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户登录日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_admin_role_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户和角色关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_growth_change_history`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '成长值变化历史记录id',
...
CREATE TABLE `ums_integration_change_history`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '积分变化历史记录id',
  `member_id` bigint(0) NULL DEFAULT NULL COMMENT '会员id',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `change_type` int(0) NULL DEFAULT NULL COMMENT '改变类型：0->增加；1->减少',
  `change_count` int(0) NULL DEFAULT NULL COMMENT '积分改变数量',
...
CREATE TABLE `ums_integration_consume_setting`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '积分消费设置id',
...
CREATE TABLE `ums_member_level`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员等级id',
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '会员等级名称',
  `growth_point` int(0) NULL DEFAULT NULL COMMENT '增长点',
...
CREATE TABLE `ums_member_login_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员登录记录id',
  `member_id` bigint(0) NULL DEFAULT NULL COMMENT '会员id',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `ip` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'ip',
  `city` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '城市',
  `login_type` int(0) NULL DEFAULT NULL COMMENT '登录类型：0->PC；1->android;2->ios;3->小程序',
  `province` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '省份',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ums_member_member_tag_relation`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '用户和标签关系id',
  `member_id` bigint(0) NULL DEFAULT NULL COMMENT '会员id',
...
CREATE TABLE `ums_member_product_category_relation`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员与产品分类关系id',
  `member_id` bigint(0) NULL DEFAULT NULL COMMENT '会员id',
  `product_category_id` bigint(0) NULL DEFAULT NULL COMMENT '产品分类id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ums_member_receive_address`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员收货地址id',
  `member_id` bigint(0) NULL DEFAULT NULL COMMENT '会员id',
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人名称',
  `phone_number` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电话号码',
...
CREATE TABLE `ums_member_rule_setting`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员积分成长规则id',
...
CREATE TABLE `ums_member_statistics_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员统计信息id',
  `member_id` bigint(0) NULL DEFAULT NULL COMMENT '会员id',
  ...
  `collect_product_count` int(0) NULL DEFAULT NULL COMMENT '商品收藏数',
  `collect_subject_count` int(0) NULL DEFAULT NULL COMMENT '专题收藏数',
  `collect_topic_count` int(0) NULL DEFAULT NULL COMMENT '主题收藏数',
  `collect_comment_count` int(0) NULL DEFAULT NULL COMMENT '评论收藏数',
  `invite_friend_count` int(0) NULL DEFAULT NULL COMMENT '好友邀请数',
...
CREATE TABLE `ums_member_tag`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '用户标签id',
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户标签',
...
CREATE TABLE `ums_member_task`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '会员任务id',
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '会员任务名称',
...
CREATE TABLE `ums_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台资源表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_role_menu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 96 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台角色菜单关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_role_resource_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 178 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台角色资源关系表' ROW_FORMAT = Dynamic;
