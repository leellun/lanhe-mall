/*
 ...
 Source Schema         : lanhe_sys

 Target Server Type    : MySQL
 Target Server Version : 80031
 File Encoding         : 65001

 Date: 12/02/2023 14:55:42
*/
...
-- ----------------------------
INSERT INTO `sys_department` VALUES (2, 7, 2, '研发部', 3, 1, 1, 1, '2019-03-25 09:15:32', '2023-01-28 19:22:15');
INSERT INTO `sys_department` VALUES (5, 7, 0, '运维部', 5, 1, 1, 1, '2019-03-25 09:20:44', '2023-01-28 17:40:13');
INSERT INTO `sys_department` VALUES (6, 8, 0, '测试部', 6, 1, 1, 1, '2019-03-25 09:52:18', '2023-01-28 17:40:23');
INSERT INTO `sys_department` VALUES (7, NULL, 2, '华南分部', 1, 1, 1, 1, '2019-03-25 11:04:50', '2023-01-28 19:37:13');
INSERT INTO `sys_department` VALUES (8, NULL, 2, '华北分部', 2, 1, 1, 1, '2019-03-25 11:04:53', '2023-01-28 17:11:23');
INSERT INTO `sys_department` VALUES (15, 8, 0, 'UI部门', 7, 1, 1, 1, '2020-05-13 22:56:53', '2023-01-28 17:40:46');
INSERT INTO `sys_department` VALUES (17, 2, 0, '研发一组', 4, 1, 1, 1, '2020-08-02 14:49:07', '2023-01-28 20:54:30');
...
CREATE TABLE `sys_menu`  (
  ...
  `gmt_modified` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 225 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统菜单' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (207, NULL, 15, 1, '营销管理', 'sms', 'RouteView', 4, 'sms', NULL, 0, 1, 1, 0, NULL, 1, 1, '2023-02-11 01:26:10', '2023-02-12 14:30:00');
INSERT INTO `sys_menu` VALUES (208, 207, 0, 1, '秒杀活动', 'flash', 'sms/flash', 0, NULL, NULL, 0, 1, 1, 0, NULL, 1, NULL, '2023-02-11 01:27:08', NULL);
INSERT INTO `sys_menu` VALUES (209, 207, 0, 1, '秒杀时间段', 'flashSession', 'sms/flash/flashSession', 1, NULL, NULL, 0, 1, 1, 0, NULL, 1, 1, '2023-02-11 01:27:56', '2023-02-11 01:30:52');
INSERT INTO `sys_menu` VALUES (210, 207, 0, 1, '秒杀时间段选择', 'selectSession', 'sms/flash/selectSession', 2, NULL, NULL, 0, 1, 1, 1, NULL, 1, 1, '2023-02-11 01:28:34', '2023-02-11 17:10:31');
INSERT INTO `sys_menu` VALUES (211, 207, 0, 1, '秒杀商品', 'flashProductRelation', 'sms/flash/flashProductRelation', 3, NULL, NULL, 0, 1, 1, 1, NULL, 1, 1, '2023-02-11 01:29:00', '2023-02-11 17:11:03');
INSERT INTO `sys_menu` VALUES (212, 207, 0, 1, '优惠券', 'coupon', 'sms/coupon', 4, NULL, NULL, 0, 1, 1, 0, NULL, 1, NULL, '2023-02-11 01:29:32', NULL);
INSERT INTO `sys_menu` VALUES (213, 207, 0, 1, '添加优惠券', 'addCoupon', 'sms/coupon/addOrUpdate', 5, NULL, NULL, 0, 1, 1, 1, NULL, 1, 1, '2023-02-11 01:30:14', '2023-02-11 01:41:49');
INSERT INTO `sys_menu` VALUES (214, 207, 0, 1, '修改优惠券', 'updateCoupon', 'sms/coupon/addOrUpdate', 6, NULL, NULL, 0, 1, 1, 1, NULL, 1, 1, '2023-02-11 01:32:03', '2023-02-11 01:41:34');
INSERT INTO `sys_menu` VALUES (216, 207, 0, 1, '优惠券领取详情', 'couponHistory', 'sms/coupon/history', 7, NULL, NULL, 0, 1, 1, 1, NULL, 1, 1, '2023-02-11 01:33:27', '2023-02-11 01:33:35');
INSERT INTO `sys_menu` VALUES (217, 207, 0, 1, '品牌推荐', 'brand', 'sms/brand', 8, NULL, NULL, 0, 1, 1, 0, NULL, 1, 1, '2023-02-11 01:34:02', '2023-02-11 01:34:13');
INSERT INTO `sys_menu` VALUES (218, 207, 0, 1, '新品推荐', 'new', 'sms/new', 9, NULL, NULL, 0, 1, 1, 0, NULL, 1, 1, '2023-02-11 01:34:52', '2023-02-11 01:34:58');
INSERT INTO `sys_menu` VALUES (219, 207, 0, 1, '人气推荐', 'hot', 'sms/hot', 10, NULL, NULL, 0, 1, 1, 0, NULL, 1, NULL, '2023-02-11 01:35:25', NULL);
INSERT INTO `sys_menu` VALUES (220, 207, 0, 1, '专题推荐', 'subject', 'sms/subject', 11, NULL, NULL, 0, 1, 1, 0, NULL, 1, 1, '2023-02-11 01:35:50', '2023-02-11 01:36:07');
INSERT INTO `sys_menu` VALUES (221, 207, 0, 1, '广告列表', 'advertise', 'sms/advertise', 12, NULL, NULL, 0, 1, 1, 0, NULL, 1, NULL, '2023-02-11 01:36:46', NULL);
INSERT INTO `sys_menu` VALUES (222, 207, 0, 1, '添加广告', 'addAdvertise', 'sms/advertise/addOrUpdate', 13, NULL, NULL, 0, 1, 1, 1, NULL, 1, 1, '2023-02-11 01:37:25', '2023-02-11 01:41:09');
INSERT INTO `sys_menu` VALUES (223, 207, 0, 1, '编辑广告', 'updateAdvertise', 'sms/advertise/addOrUpdate', 14, NULL, NULL, 0, 1, 1, 1, NULL, 1, 1, '2023-02-11 01:37:57', '2023-02-11 01:41:18');
...
) ENGINE = InnoDB AUTO_INCREMENT = 252 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色菜单关联' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role_menu` VALUES (239, 207, 1);
...
INSERT INTO `sys_role_menu` VALUES (247, 223, 1);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 7, 11, 'admin', '宋啊', '手动阀手动阀', 1, NULL, NULL, NULL, 'e10adc3949ba59abbe56e057f20f883e', 0, 1, 0, 0, '2023-01-19 19:12:57', '2023-01-19 19:13:04', '2023-02-11 01:40:24', 1, 1, '2023-01-15 22:57:05', '2023-02-11 01:37:13');
