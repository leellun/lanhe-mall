...
import com.newland.lanhe.system.model.dto.DeptQueryDTO;
import com.newland.lanhe.system.model.vo.SysDepartmentVo;
import com.newland.lanhe.system.service.SysDepartmentService;
...
public class SysDepartmentServiceImpl extends ServiceImpl<SysDepartmentMapper, SysDepartment> implements SysDepartmentService {
    ...
    private void updateSubCount(Long pid) {
        int count = baseMapper.selectCount(Wrappers.<SysDepartment>lambdaQuery().eq(SysDepartment::getPid, pid));
